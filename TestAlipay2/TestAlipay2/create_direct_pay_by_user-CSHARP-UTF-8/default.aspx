    ...
    <div class="content">
        <form class="alipayform" target="_blank" runat="server">
            ...
            <div class="element">
                ...
                <div class="einput">
                    <asp:TextBox ID="WIDsubject" name="WIDsubject"  value="" runat="server"></asp:TextBox>
                </div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput">
                    <asp:TextBox ID="WIDtotal_fee" name="WIDtotal_fee"  value ="" runat="server"></asp:TextBox>
                </div>
                <br>
			...
			<div class="element">
				...
				<div class="einput">
				<asp:TextBox ID="WIDbody" name="WIDbody" value="" runat="server"></asp:TextBox>
				</div>
				<br>
