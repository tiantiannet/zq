								...
								<div class="container-fluid">
									<section>
										<section id="middle">
											...
											<h2 class="h2-tab">
												<a href="cooper/index.html" class="">进行中的挑战</a>
											</h2>
											<h2 class="h2-tab">
												<a href="cooper/index.html?isHistory=true" class="off">挑战历史</a>
											</h2>
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="panel panel-default project ">
														<div class="panel-body" runat="server" id="ele">
															<div class="row">
																<!-- new start-->
																<div class="col-md-5">
																	<h2 style="margin: 12px 0 2px 0;">
																		<a href="cooper/screening/user/screening_list.html?recruitId=3162">[初级]Java工程师</a>
																	</h2>
																	<div style="width: 280px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
																		<small class="text-muted">[2016.05.09]
																...
																<div class="col-md-3">
																	...
																	<a href="cooper/invite/user/invite_user.html?recruitId=3162" class="btn btn-new1" style="margin: 16px 5px;">
																		邀请
																	</a>
											...
											<div class="media">
												...
												<div class="media-body">
													<h4 class="media-heading">
														...
														<span>北京交通大学软件学院.NET课程股份有限公司</span>
													</h4>
								...
								<div class="panel panel-outline panel-no-padding hidden-xs">
									<div class="panel-body">
										...
										<div class="stat-block stat-success">
											<div class="icon">
												<b class="icon-cover"></b>
												<span class="glyphicon  glyphicon -bar-chart-o"></span>
											</div>
											<div class="details">
												<div class="number">0</div>
										...
										<div class="stat-block stat-primary">
											<div class="icon">
												<b class="icon-cover"></b>
												<span class="glyphicon  glyphicon -tachometer"></span>
											</div>
											<div class="details">
												<div class="number">0</div>
